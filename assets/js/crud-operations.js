...
const crudOperations = {
            ...
            <div class="cart-item">
               ...
               <div class="item-details">
                   <div class="item-name">ProducktName: ${
                    ...
                    <div class="item-price">Preis: ${value.productPrice}</div>
                </div>
                <div class="quantity-controls">
                            <button onclick="crudOperations.changeQuantity(${key}, ${
          value.quantity - 1
        })">-</button>
                    <span id="product2-quantity">${value.quantity}</span>
                    <button onclick="crudOperations.changeQuantity(${key}, ${
          value.quantity + 1
        })">+</button>
                  </div>     
  ...
  changeQuantity(key, quantity) {
    if (quantity == 0) {
      ...
      shoppingCartList[key].price = quantity * productsList[key].productPrice;
    }
    crudOperations.displayShoppingCart();
    crudOperations.saveToLocalStorage();
  },
